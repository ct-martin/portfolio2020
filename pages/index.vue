        ...
        <v-col cols="12" md="10">
          <v-container fluid>
            ...
            <p class="subtitle-2 mb-0">
              Available Full-Time, Front-end Web Development
            </p>
          </v-container>
        </v-col>
      </v-row>
    </v-container>
    <v-container fluid class="blue darken-4 white--text">
      <v-row
        align="center"
        justify="center"
      >
              ...
              <v-col cols="12" md="6" lg="4">
                <v-card tile>
                  ...
                  <v-card-text class="text--primary">
                    Single-Page App Search Engine for APIs using Schema.org markup.
                  </v-card-text>
                  <v-card-actions>
                    <v-btn text href="https://find.ctmartin.me/" target="_blank" rel="noopener" :ripple="false">
                      View
                    </v-btn>
                    <v-btn text nuxt to="/projects/find" :ripple="false">
                      Learn More
                    </v-btn>
                  </v-card-actions>
                </v-card>
              ...
              <v-col cols="12" md="6" lg="4" offset-lg="1">
                <v-card tile>
                  ...
                  <v-card-actions>
                    ...
                    <v-btn text nuxt to="/projects/si" :ripple="false">
                      Learn More
                    </v-btn>
                  </v-card-actions>
                </v-card>
      ...
      >
        <v-col cols="12" md="10" class="pt-0">
          <v-container fluid>
            ...
            <p class="mb-0">
              I'm a recent grad from RIT (BS New Media Interative Development 2020).
              I minored in Museum Studies, focusing on how people use technology to engage with culture.
              My tech interests include metadata, visualization, and rich content editing.
            </p>
          </v-container>
        </v-col>
      </v-row>
